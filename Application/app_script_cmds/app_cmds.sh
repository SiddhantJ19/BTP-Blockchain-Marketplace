...
echo "\n just pending trades" 
source $app_cmd_dir/org1_tradeStatusForDevice.sh

# echo "\n pending trade == approved trade" 
# source $app_cmd_dir/sharing_org1_to_2.sh
# how to delete the interest token from marketplace; may be update structure by adding seller field
